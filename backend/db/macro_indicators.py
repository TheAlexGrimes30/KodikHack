...
class MacroIndicator(Base, TimestampMixin):
    ...
    feed: Mapped[DataFeed] = relationship(back_populates="macro_indicators")

    __table_args__ = (
        UniqueConstraint("indicator", "observed_at", name="uq_macro_indicator_observed_at"),
        Index("idx_macro_indicator_date", "indicator", "observed_at"),
    )
